...
namespace Atlas.Cloud.Moonshot;

/// <summary>
/// Moonshot（Kimi）聊天补全服务实现，调用 Moonshot OpenAI 兼容 API
/// </summary>
public sealed class MoonshotChatCompletion : IChatCompletionService
{
    ...
    public MoonshotChatCompletion(string apiKey, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
