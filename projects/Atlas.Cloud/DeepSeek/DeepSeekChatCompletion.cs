...
/// <summary>
/// DeepSeek 聊天补全服务实现，调用 DeepSeek Chat Completions API（兼容 OpenAI 格式）
/// </summary>
public sealed class DeepSeekChatCompletion : IChatCompletionService
{
    ...
    public DeepSeekChatCompletion(string apiKey, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
