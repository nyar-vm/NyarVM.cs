...
namespace Atlas.Cloud.DeepSeek;

/// <summary>
/// DeepSeek 向量嵌入服务实现，调用 DeepSeek Embeddings API（OpenAI 兼容）
/// </summary>
public sealed class DeepSeekEmbedding : IEmbeddingService
{
    ...
    public DeepSeekEmbedding(string apiKey, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
        _base_url = "https://api.deepseek.com/v1/embeddings";
