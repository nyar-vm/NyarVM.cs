...
/// <summary>
/// OpenAI 聊天补全服务实现，调用 OpenAI Chat Completions API
/// </summary>
public sealed class OpenAiChatCompletion : IChatCompletionService
{
    ...
    public OpenAiChatCompletion(string apiKey, string? baseUrl = null, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
        _base_url = baseUrl ?? "https://api.openai.com/v1/chat/completions";
