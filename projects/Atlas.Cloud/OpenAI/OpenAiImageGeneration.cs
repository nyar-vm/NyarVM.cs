...
/// <summary>
/// OpenAI 图像生成服务实现，调用 OpenAI DALL-E Images API
/// </summary>
public sealed class OpenAiImageGeneration : IImageGenerationService
{
    ...
    public OpenAiImageGeneration(string apiKey, string? baseUrl = null, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
        _base_url = baseUrl ?? "https://api.openai.com/v1/images/generations";
