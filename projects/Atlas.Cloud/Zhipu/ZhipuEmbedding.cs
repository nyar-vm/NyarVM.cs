...
/// <summary>
/// 智谱向量嵌入服务实现，调用智谱 Embedding API（OpenAI 兼容）
/// </summary>
public sealed class ZhipuEmbedding : IEmbeddingService
{
    ...
    public ZhipuEmbedding(string apiKey, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
        _base_url = "https://open.bigmodel.cn/api/paas/v4/embeddings";
