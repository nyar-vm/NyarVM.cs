...
/// <summary>
/// 智谱 GLM 聊天补全服务实现，调用智谱 OpenAI 兼容 API
/// </summary>
public sealed class ZhipuChatCompletion : IChatCompletionService
{
    ...
    public ZhipuChatCompletion(string apiKey, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
