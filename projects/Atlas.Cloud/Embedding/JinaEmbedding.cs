...
namespace Atlas.Cloud.Embedding;

/// <summary>
/// Jina AI 向量嵌入服务实现，调用 Jina AI Embeddings API
/// </summary>
public sealed class JinaEmbedding : IEmbeddingService
{
    ...
    public JinaEmbedding(string apiKey, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
