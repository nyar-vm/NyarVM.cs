...
/// <summary>
/// 通义千问聊天补全服务实现，调用 DashScope API（OpenAI 兼容格式）
/// </summary>
public sealed class TongyiChatCompletion : IChatCompletionService
{
    ...
    public TongyiChatCompletion(string apiKey, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
