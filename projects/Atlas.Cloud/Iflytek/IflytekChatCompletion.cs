...
/// <summary>
/// 讯飞星火聊天补全服务实现，调用讯飞星火 HTTP API
/// </summary>
public sealed class IflytekChatCompletion : IChatCompletionService
{
    ...
    /// <param name="apiSecret">API 密钥签名</param>
    /// <param name="httpClient">HTTP 客户端</param>
    public IflytekChatCompletion(string appId, string apiKey, string apiSecret, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
    ...
    public async Task<ChatResponse> complete(ChatRequest request, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            http_request.Headers.Add("Authorization", $"Bearer {_api_key}:{_api_secret}");
