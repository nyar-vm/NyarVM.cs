...
/// <summary>
/// 火山引擎向量嵌入服务实现，调用火山引擎 Embedding API
/// </summary>
public sealed class VolcengineEmbedding : IEmbeddingService
{
    ...
    /// <param name="endpointId">推理接入点标识</param>
    /// <param name="httpClient">HTTP 客户端</param>
    public VolcengineEmbedding(string apiKey, string endpointId, HttpClient? httpClient = null)
    {
        _api_key = apiKey;
        _endpoint_id = endpointId;
        _base_url = "https://opens.volcengineapi.com/v1/embeddings";
