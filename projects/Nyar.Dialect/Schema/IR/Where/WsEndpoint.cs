...
public sealed class WsEndpoint : EndpointDefinition
{
    public WsEndpoint(string name, IReadOnlyList<ParameterDefinition> parameters, SchemaType? returnType,
        string? path = null, SchemaType? messageType = null, IReadOnlyList<AttributeDefinition>? attributes = null,
    ...
    public SchemaType? message_type { get; }
}