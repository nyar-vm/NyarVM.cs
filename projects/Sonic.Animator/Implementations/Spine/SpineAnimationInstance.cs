...
///     Spine 动画运行实例
/// </summary>
internal sealed class SpineAnimationInstance : IAnimationInstance
{
    ...
    public void update_frame(float deltaTime)
    {
        ...
        SpineRenderer.update_bones(scaledDeltaTime);
    }
    ...
    public void draw_to_canvas(IRenderCanvas canvas)
    {
        ...
        SpineRenderer.render_to_canvas(canvas, horizontal_position, vertical_position, scale_ratio, opacity_value);
    }
