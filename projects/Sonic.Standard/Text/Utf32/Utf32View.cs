...
public readonly struct Utf32View : ITextView
{
    public readonly Utf32Text text;
    public readonly TextSpan span;

    public Utf32View(Utf32Text text, TextSpan span)
    {
        this.text = text;
        this.span = span;
    }
    ...
    ///     获取字节长度
    /// </summary>
    public int byte_length => span.length * 4;
    ...
    public Utf32View view(TextSpan span)
    {
        ...
        return new Utf32View(text, new TextSpan(absStart, absEnd - absStart));
    }
    ...
    {
        if (obj is not Utf32View other) return false;
    ...
    public static bool operator ==(Utf32View left, Utf32View right)
    {
