...
public sealed class PwaOfflineScenarioTests : IDisposable
{
    ...
    {
        _output = output;
        _temp_dir = Path.Combine(Path.GetTempPath(), $"voa-pwa-offline-{Guid.NewGuid():N}");
    ...
    {
        var swScript = generate_service_worker_content([
            "/index.html",
            "/main.wasm",
            "/main.js",
            "/voa-runtime.js",
    ...
    {
        var swScript = generate_service_worker_content(["/index.html"]);
    ...
    {
        var manifest = generate_manifest_json(
            "My VOA App",
            "VOA",
            "#0d1117",
            "#161b22");
    ...
    {
        var offlineHtml = generate_offline_page("My VOA App");
    ...
    {
        var regScript = generate_registration_script();
    ...
    public void CacheFirst_ReturnsCacheWhenOffline()
    {
        ...
        var cacheDirs = Path.Combine(_temp_dir, "cache");
    ...
    private static string generate_service_worker_content(string[] precacheUrls, string strategy = "network-first")
    {
    ...
    private static string generate_manifest_json(string appName, string shortName, string themeColor,
    ...
    private static string generate_offline_page(string appName)
    {
        return $$"""
                 <!DOCTYPE html>
                 <html lang="zh-CN">
    ...
    private static string generate_registration_script()
    {
        return """
               (function() {
