...
{
    private const string _npm_package_json = @"{
            ""name"": ""test-package"",
            ""dist-tags"": {
                ""latest"": ""1.2.3""
            },
    ...
    private const string _npm_search_json = @"{
            ""objects"": [
                {
                    ""package"": {
                        ""name"": ""test-package"",
    ...
    public async Task GetPackageAsync_LatestVersion_ReturnsCorrectPackage()
    {
        ...
        handler.add_route("https://registry.npmjs.org/test-package", HttpStatusCode.OK, _npm_package_json);
    ...
    {
        var handler = new RoutingFakeHttpMessageHandler();
        handler.add_route("https://registry.npmjs.org/test-package/2.0.0", HttpStatusCode.OK, @"{
                ""version"": ""2.0.0"",
                ""description"": ""大版本更新"",
    ...
    public async Task GetPackageAsync_NotFound_ThrowsRegistryException()
    {
        ...
        var ex = await Assert.ThrowsAsync<RegistryException>(() => registry.GetPackageAsync("nonexistent", "latest"));
    ...
    {
        var handler = new RoutingFakeHttpMessageHandler();
        handler.add_route("https://registry.npmjs.org/-/v1/search", HttpStatusCode.OK, _npm_search_json);
    ...
    public async Task DownloadPackageAsync_RequiresDistTarball()
    {
        ...
        await Assert.ThrowsAsync<RegistryException>(() => registry.DownloadPackageAsync(package, Path.GetTempPath()));
    }
