...
{
    private const string _nu_get_latest_json = @"{
            ""items"": [
                {
                    ""items"": [
                        {
    ...
    public async Task GetPackageAsync_LatestVersion_ReturnsCorrectPackage()
    {
        ...
        handler.add_route("https://api.nuget.org/v3/registration5-gz-semver2/newtonsoft.json/index.json",
            HttpStatusCode.OK, _nu_get_latest_json);
    ...
    public async Task GetPackageAsync_WithDependencies_ParsesCorrectly()
    {
        ...
        var handler = new RoutingFakeHttpMessageHandler();
        handler.add_route("https://api.nuget.org/v3/registration5-gz-semver2/entityframeworkcore/index.json",
    ...
    public async Task GetPackageAsync_SpecificVersion_ReturnsCorrectPackage()
    {
        ...
        var handler = new RoutingFakeHttpMessageHandler();
        handler.add_route("https://api.nuget.org/v3/registration5-gz-semver2/test.pkg/1.0.0.json",
    ...
    public async Task GetPackageAsync_NotFound_ThrowsRegistryException()
    {
        ...
        await Assert.ThrowsAsync<RegistryException>(() => registry.GetPackageAsync("Nonexistent.Pkg", "latest"));
    }
    ...
    public async Task SearchPackagesAsync_ReturnsResults()
    {
        ...
        var handler = new RoutingFakeHttpMessageHandler();
        handler.add_route("https://api.nuget.org/v3/query?q=json",
    ...
    public async Task GetPackageVersionsAsync_ReturnsVersionList()
    {
        ...
        var handler = new RoutingFakeHttpMessageHandler();
        handler.add_route("https://api.nuget.org/v3/registration5-gz-semver2/test.pkg/index.json",
