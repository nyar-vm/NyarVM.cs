...
{
    private readonly List<(string prefix, HttpStatusCode status, string content)> _routes = [];

    public void add_route(string urlPrefix, HttpStatusCode status, string content)
    {
